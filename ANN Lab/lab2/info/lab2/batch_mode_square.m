...
for i = 1:80
    ...
    if i==4
        print('lab2/result4_1','-dpng')
        w4=w
    end
   
    if i==5
        print('lab2/result5_1','-dpng')
        w5=w
    end
     if i==6
        print('lab2/result6_1','-dpng')
        w6=w
    end
    r(i) = max(abs((y-f)));
...
print('lab2/residuals_batch_mode1_1','-dpng')
%%
figure;
plot(units_list,r,'b')
error = ones(1,80);
...
print('lab2/residuals_batch_mode2_1','-dpng')
%%
figure;
plot(units_list,r,'b')
error = ones(1,80);
...
print('lab2/residuals_batch_mode3_1','-dpng')
%%
