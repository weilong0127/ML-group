%% What happens if you bias the patterns, 
% e.g. use sign(0.5+randn(300,100)) 
% or something similar to make them contain more +1? 
% How does this relate to the capacity results of the picture patterns?
%% STEP 1:Create 300 random patterns
seed=20;
rng(seed)
x = sgn(0.5+randn(300,100));
